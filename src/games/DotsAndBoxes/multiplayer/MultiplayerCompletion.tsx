...
import { subscribeToRoom, startGame, leaveRoom, clientId, DABRoom } from './MultiplayerManager';

interface Props {
  room: DABRoom;
  onLeave: () => void;
  onRoomUpdated: (room: DABRoom) => void;
}
      ...
      <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full gap-8">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          {!room.isDraw && winnerPlayer && (
            <p className="text-indigo-600 font-bold mt-2 text-xl">{room.scores[winnerPlayer.number]} boxes</p>
          )}
        </div>
