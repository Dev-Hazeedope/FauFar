...
import { subscribeToRoom, startGame, leaveRoom, clientId, FTTRoom } from './MultiplayerManager';

interface Props {
  room: FTTRoom;
  onLeave: () => void;
  onRoomUpdated: (room: FTTRoom) => void;
}
      ...
      <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full gap-8">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          {!room.isDraw && winnerPlayer && (
            <p className="text-indigo-600 font-bold mt-2 text-xl">{room.scores[winnerPlayer.number]} rounds won</p>
          )}
        </div>
        ...
        <div className="game-panel">
          ...
          <div className="space-y-3">
            {Object.values(room.players).sort((a: any, b: any) => room.scores[b.number] - room.scores[a.number]).map((p: any) => (
